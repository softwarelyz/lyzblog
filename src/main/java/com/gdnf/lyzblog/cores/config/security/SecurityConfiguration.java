package com.gdnf.lyzblog.cores.config.security;


import com.gdnf.lyzblog.cores.service.CustomUserDetailsService;
import com.gdnf.lyzblog.cores.service.LoginSuccessHandler;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    @Bean
    public com.gdnf.lyzblog.cores.config.security.CustomSecurityMetadataSource securityMetadataSource() {
        /**默认采用配置文件进行权限认证*/
//        if("yml".equals(settings.getOpenway())){
        return new com.gdnf.lyzblog.cores.config.security.CustomSecurityMetadataSource(settings.getUrlroles());
//        }else{
